...
**Answer** Not too much, there were only 11 instances where the two functions grouped grantees into different categories. That said, it does appear that the two functions have different standards, with ngram seeming to be better about spelling errors while key_collision_merges looks like it highlights punctuation-related issues. So it looks like it's better to use both to try and catch more things within such a large dataset.
